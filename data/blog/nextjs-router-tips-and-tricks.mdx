---
title: Next.js Router – Tips & Tricks
summary: Sometimes we can skip something new that was released in a framework that we use. Also, it could be some changes that keep backward compatibility and we should deal with it. These tips and tricks for you on the Next.js router help you make your DX much better.
