const headers = [
	{
		...
		value:
			"default-src 'self'; style-src 'self' 'unsafe-inline'; script-src 'self' https://static.cloudflareinsights.com; img-src 'self' data:; connect-src 'self' https://vitals.vercel-insights.com https://cloudflareinsights.com",
	},
